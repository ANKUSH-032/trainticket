...
import com.sms.trainticketbook.project.DataWareHouse.Registeration;
...
public class SelectPage extends AppCompatActivity {
    ...
    public static final String s = "userbalance.s";
    public static final String s1 = "userbalance.s1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spManipulation=SPManipulation.getInstance(this);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (parent.getSelectedItemPosition()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        spManipulation.saveUSERId("NA");
                        spManipulation.saveIsLogin(false);
                        finish();
